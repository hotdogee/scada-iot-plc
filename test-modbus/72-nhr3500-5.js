...
(async function () {
  ...
  try {
    ...
    ;(async function parse() {
      ...
      logger.info(result)
      // 2019-04-26T19:40:15.570Z [+191ms] info: [ { 'AB線電壓': [ 393.66, 'V' ], 'BC線電壓': [ 392.19, 'V' ], 'CA線電壓': [ 391.55, 'V' ], 'A相電流': [ 11.58, 'A' ], 'B相電流': [ 5.7, 'A' ], 'C相電流': [ 13.68, 'A' ], '有功功率': [ 6732, 'kW' ], '無功功率': [ 1686, 'kvar' ], '視在功率': [ 7008, 'kVA' ], '功率因數': [ 96, '%' ] }, { '有功電量': [ 1565.18, 'kWh' ], '無功電量': [ 281.01, 'kvarh' ], '視在電量': [ 1696.19, 'kVAh' ] } ]
      // 2019-04-26T19:40:15.762Z [+192ms] info: [ { 'AB線電壓': [ 393.57, 'V' ], 'BC線電壓': [ 392.1, 'V' ], 'CA線電壓': [ 391.46, 'V' ], 'A相電流': [ 9.78, 'A' ], 'B相電流': [ 3.96, 'A' ], 'C相電流': [ 11.94, 'A' ], '有功功率': [ 5652, 'kW' ], '無功功率': [ 504, 'kvar' ], '視在功率': [ 5808, 'kVA' ], '功率因數': [ 97.3, '%' ] }, { '有功電量': [ 1565.18, 'kWh' ], '無功電量': [ 281.01, 'kvarh' ], '視在電量': [ 1696.19, 'kVAh' ] } ]
      // 2019-04-26T19:40:15.955Z [+193ms] info: [ { 'AB線電壓': [ 393.47, 'V' ], 'BC線電壓': [ 391.93, 'V' ], 'CA線電壓': [ 391.2, 'V' ], 'A相電流': [ 9.06, 'A' ], 'B相電流': [ 3.96, 'A' ], 'C相電流': [ 11.04, 'A' ], '有功功率': [ 5070, 'kW' ], '無功功率': [ -1050, 'kvar' ], '視在功率': [ 5442, 'kVA' ], '功率因數': [ 93.1, '%' ] }, { '有功電量': [ 1565.18, 'kWh' ], '無功電量': [ 281.01, 'kvarh' ], '視在電量': [ 1696.19, 'kVAh' ] } ]
      // 2019-04-26T19:40:16.146Z [+191ms] info: [ { 'AB線電壓': [ 393.47, 'V' ], 'BC線電壓': [ 391.93, 'V' ], 'CA線電壓': [ 391.29, 'V' ], 'A相電流': [ 9.36, 'A' ], 'B相電流': [ 3.96, 'A' ], 'C相電流': [ 11.34, 'A' ], '有功功率': [ 5340, 'kW' ], '無功功率': [ -600, 'kvar' ], '視在功率': [ 5574, 'kVA' ], '功率因數': [ 95.8, '%' ] }, { '有功電量': [ 1565.18, 'kWh' ], '無功電量': [ 281.01, 'kvarh' ], '視在電量': [ 1696.19, 'kVAh' ] } ]
      // 2019-04-26T19:40:16.337Z [+191ms] info: [ { 'AB線電壓': [ 393.56, 'V' ], 'BC線電壓': [ 392.02, 'V' ], 'CA線電壓': [ 391.29, 'V' ], 'A相電流': [ 7.8, 'A' ], 'B相電流': [ 2.64, 'A' ], 'C相電流': [ 9.84, 'A' ], '有功功率': [ 3990, 'kW' ], '無功功率': [ 0, 'kvar' ], '視在功率': [ 3990, 'kVA' ], '功率因數': [ 100, '%' ] }, { '有功電量': [ 1565.18, 'kWh' ], '無功電量': [ 281.01, 'kvarh' ], '視在電量': [ 1696.19, 'kVAh' ] } ]
      // 2019-04-26T19:40:16.529Z [+192ms] info: [ { 'AB線電壓': [ 393.64, 'V' ], 'BC線電壓': [ 392.19, 'V' ], 'CA線電壓': [ 391.48, 'V' ], 'A相電流': [ 10.26, 'A' ], 'B相電流': [ 4.5, 'A' ], 'C相電流': [ 12.36, 'A' ], '有功功率': [ 5814, 'kW' ], '無功功率': [ 1614, 'kvar' ], '視在功率': [ 6132, 'kVA' ], '功率因數': [ 94.8, '%' ] }, { '有功電量': [ 1565.18, 'kWh' ], '無功電量': [ 281.01, 'kvarh' ], '視在電量': [ 1696.19, 'kVAh' ] } ]

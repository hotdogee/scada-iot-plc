...
async function async_all_read() {
    ...
    // LMAG
    var addr = 22
    promises.push(master.readInputRegisters(addr, 4115, 2, s16_float_le).catch(console.error))
    promises.push(master.readInputRegisters(addr, 4112, 2, float_be).catch(console.error))
